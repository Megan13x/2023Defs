...
QBShared.Weapons = {
	...
	[`weapon_elvendagger`] 				= {['name'] = 'weapon_elvendagger', 		['label'] = 'elvendagger', 				['weapontype'] = 'Melee',	['ammotype'] = nil,	['damagereason'] = 'Knifed / Stabbed / Eviscerated'},
	[`weapon_ghostacientsword`] 		= {['name'] = 'weapon_ghostacientsword', 	['label'] = 'ghost_acient_sword', 		['weapontype'] = 'Melee',	['ammotype'] = nil,	['damagereason'] = 'Knifed / Stabbed / Eviscerated'},
	[`weapon_ghostaxe5`] 				= {['name'] = 'weapon_ghostaxe5', 			['label'] = 'GHOSTAXE5', 				['weapontype'] = 'Melee',	['ammotype'] = nil,	['damagereason'] = 'Knifed / Stabbed / Eviscerated'},
	[`weapon_ghostbowknife`] 			= {['name'] = 'weapon_ghostbowknife', 		['label'] = 'ghostbowknife', 			['weapontype'] = 'Melee',	['ammotype'] = nil,	['damagereason'] = 'Knifed / Stabbed / Eviscerated'},
	[`weapon_ghosttacknife`] 			= {['name'] = 'weapon_ghosttacknife', 		['label'] = 'ghosttacknife', 			['weapontype'] = 'Melee',	['ammotype'] = nil,	['damagereason'] = 'Knifed / Stabbed / Eviscerated'},
	[`weapon_ghostbat`] 				= {['name'] = 'weapon_ghostbat', 			['label'] = 'Ghost Bat', 				['weapontype'] = 'Melee',	['ammotype'] = nil,	['damagereason'] = 'Knifed / Stabbed / Eviscerated'},
	[`weapon_analbeads`] 				= {['name'] = 'weapon_analbeads', 			['label'] = 'analbeads', 				['weapontype'] = 'Melee',	['ammotype'] = nil,	['damagereason'] = 'Knifed / Stabbed / Eviscerated'},
